...
@log
def message_from_server(server_socket, my_username):
...
def main():
    ...
    try:
        ...
        receiver = Thread(target=message_from_server, args=(client_socket, client_name))
        receiver.daemon = True
        receiver.start()

        # затем запускаем отправку сообщений и взаимодействие с пользователем.
        user_interface = Thread(target=user_interactive, args=(client_socket, client_name))
