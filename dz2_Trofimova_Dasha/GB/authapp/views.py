...
from authapp.models import ShopUser, ShopClientProfile
...
def edit(request):
    ...
    if request.method == 'POST':
        edit_form = ShopUserProfileEditForm(request.POST, request.FILES, \
        ...
        edit_form = ShopUserProfileEditForm(instance=request.user)
